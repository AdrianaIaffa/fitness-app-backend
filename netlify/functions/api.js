...
router.get('/calories/total/:id', async (req, res) => {
  try {
...
router.post('/foods/new/:id', async (req, res) => {
  try {
...
router.post('/meals/new', async (req, res) => {
    try {
...
router.post("/workouts/new/:id", async (req, res) => {
